...
public class UpdatePersonaController {
    ...
    @PutMapping("{id}")
    public PersonaOutputDTO updateUsuarioByID(@PathVariable(value = "id") String id, @RequestBody PersonaInputDTO personaInputDTO) throws Exception {
        return updatePersonaPort.updateUsuarioByID(Integer.valueOf(id), personaInputDTO);
    }
}
