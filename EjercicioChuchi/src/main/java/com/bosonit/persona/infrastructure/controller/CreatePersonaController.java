...
public class CreatePersonaController {
    ...
    @PostMapping
    public PersonaOutputDTO crearUsuario(@RequestBody PersonaInputDTO personaInputDTO, @RequestParam(name = "idEstudiante") String idEstudiante) throws Exception {
        return createPersonaPort.crearUsuario(personaInputDTO, idEstudiante);
    }
}
